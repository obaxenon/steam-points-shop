...
const SocialProofNotification = () => {
  ...
  const purchaseData = [
    { username: "someone", package: "10,000 Steam Points", location: "United States" },
    { username: "someone", package: "20,000 Steam Points", location: "Canada" },
    { username: "someone", package: "50,000 Steam Points", location: "United Kingdom" },
    { username: "someone", package: "30,000 Steam Points", location: "Germany" },
    { username: "someone", package: "100,000 Steam Points", location: "Australia" },
    { username: "someone", package: "10,000 Steam Points", location: "France" },
    { username: "someone", package: "20,000 Steam Points", location: "Japan" },
    { username: "someone", package: "50,000 Steam Points", location: "Netherlands" },
  ];
