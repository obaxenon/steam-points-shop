...
const Index = () => {
  ...
  const externalServices = [
    { label: 'More Steam Services', url: 'https://steamgif.com', icon: ExternalLink },
    { label: 'Buy Cheap Games', url: 'https://cdgamer.com', icon: Gamepad2 },
    { label: 'Buy Steam Profile Artwork', url: 'https://steamgif.com/steam-artwork', icon: Image },
    { label: 'Game Boosting Services', url: 'https://cdgamer.com/boosting-services', icon: Zap }
  ];
